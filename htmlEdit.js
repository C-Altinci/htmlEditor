...
function createEditor(txtAreaIDs, opt) {
    ...
    var lngTR = {
        ...
        'buttonsBold': 'Kalýn yazý',
        'buttonsItalic': 'Yatýk yazý',
        'buttonsUnderline': 'Alt çizgili yazý',
        'buttonsForecolor': 'Karakter rengi',
        'buttonsBgcolor': 'Arka plan rengi',
        'buttonsLeft': 'Sola yasla',
        'buttonsCenter': 'Ortala',
        'buttonsRight': 'Saða yasla',
        'buttonsJustify': 'Ýki yana yasla',
        'buttonsOl': 'Sýralý liste',
        'buttonsUl': 'Sýrasýz liste',
        'buttonsSubscript': 'Alt simge',
        'buttonsSuperscript': 'Üst simge',
        'buttonsStrikethrough': 'Üstü çizgili yazý',
        'buttonsRemoveformat': 'Biçimlendirmeyi kaldýr',
        'buttonsIndent': 'Girinti',
        'buttonsOutdent': 'Girintiyi kaldýr',
        'buttonsHr': 'Yatay çizgi',
        'buttonsLink': 'Köprü ekle/düzenle',
        'buttonsUnlink': 'Köprüyü kaldýr',
        'buttonsInsertImage': 'Resim ekle/düzenle',
        'buttonsYoutube': 'Youtube video ekle',
        'buttonsTwitter': 'Tweet ekle',
        'buttonsFacebook': 'Facebook gönderi ekle',
        'buttonsFontSize': 'Karakter büyüklüðü',
        'buttonsFontFamily': 'Karakter türü',
        'buttonsFormatBlock': 'Satýr biçimi',
        'buttonsParagraf': 'Paragraf',
        'buttonsTicket': 'Etiket',
        'buttonsPreview': 'Önizleme',
        'buttonsVideo': 'Video ekle',
        'buttonsAudio': 'Audio ekle',
        'buttonsFullScreen': 'Tam Ekran',
        'buttonsRestoreScreen': 'Önceki Ekran',
        'buttonsSubtitleimage': 'Alt yazýlý resim',
        'buttonsInfo': 'Hakkýnda',
        'formsInfoDescription': 'Ürün: Web HTML Editor. v 1.0<br />Yazar: Çaðlayan ALTINCI<br />E-Posta: caglayana@hotmail.com',
        'alertsMultipleID': 'Birden fazla ayný ID kullanan textarea.\nID deðerleri:',
        'alertsUsedPreviously': 'Bu eleman daha önce kullanýlmýþ.\nID: [',
        'alertsElementsNotFound': "' ID deðerli eleman bulunamadý.",
        'alertsCreateLink': 'Baðlantý oluþturabilmek için geçerli bir URL girmeniz gerekir.',
        'alertsCreateImage': 'Resim oluþturabilmek için geçerli bir URL girmeniz gerekir.',
        'alertsCreateYoutube': 'Youtube video oluþturabilmek için geçerli bir URL girmeniz gerekir.',
        'alertsCreateTweet': 'Tweet oluþturabilmek için geçerli bir URL girmeniz gerekir.',
        'alertsCreateVideo': 'URL veya dosya türü geçersiz.\nGeçerli video türleri: .mp4 .mpeg .mpg .webm .ogg',
        'alertsCreateAudio': 'URL veya dosya türü geçersiz.\nGeçerli ses dosyasý türleri: .mp3 .wav .ogg',
        'alertsCreateFacebook': 'Facebook gönderi oluþturabilmek için geçerli bir URL girmeniz gerekir.',
        'alertsCreateParagraf': 'Ýçerikten bir seçim yapmalýsýnýz.',
        'alertsCreateTicket': 'Ýçerikten bir seçim yapmalýsýnýz.',
        'alertsDuplicateButton': 'Yinelenen buton adlarý \nButonlar: '
    };
    var lngEN = {
        ...
        'buttonsInfo': 'About',
        'formsInfoDescription': 'Product: Web HTML Editor. v 1.0<br />Author: Çaðlayan ALTINCI<br />E-Mail: caglayana@hotmail.com',
    ...
    function htmlEditor(txtAreaID, opt) {
        ...
        var formArgs = {
            ...
            fontEvent: function (elm, fontName, command, frm) {/* 3 font iþlemi için ortak func.*/
            ...
            twitterArgs: {
                ...
                'lang': { type: 'select', label: 'Lang', attributes: { 'class': 'selects', id: 'twitter-lang-' + edTxtElm.id }, options: { 'tr': 'Türkçe', 'en': 'English', 'de': 'German', 'ar': 'Arabic', 'es': 'Spanish', 'fa': 'Persian', 'fr': 'French', 'it': 'Italian', 'ja': 'Japanese', 'ru': 'Russian' } },
            ...
            videoBtnEvent: function (btn, frm) {
                addEvent(btn, 'click', function () {
                    ...
                    var vidTmp = UrlTest(vidUrl); //'<video title="Video dosyasý" style="width: 525px;" src="' + src + '" controls="true"></video> '
            ...
            audioBtnEvent: function (btn, frm) {
                addEvent(btn, 'click', function () {
                    ...
                    var audTmp = UrlTest(audUrl); //'<video title="Video dosyasý" style="width: 525px;" src="' + src + '" controls="true"></video> '
